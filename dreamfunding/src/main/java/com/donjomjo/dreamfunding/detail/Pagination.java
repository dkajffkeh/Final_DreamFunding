package com.donjomjo.dreamfunding.detail;
...
public class Pagination {
	...
	public static DetailPageInfo getDetailPageInfo(int listCount, int currentPage, int pageLimit, int boardLimit) {
		...
		return new DetailPageInfo(listCount, currentPage, startPage, endPage, maxPage, pageLimit, boardLimit);
