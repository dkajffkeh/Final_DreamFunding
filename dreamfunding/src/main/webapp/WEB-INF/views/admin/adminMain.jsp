...
<body id="page-top">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="${pageContext.request.contextPath}/resources/adminResources/img/undraw_profile.svg">
                            </a>
    ...
    <script src="${pageContext.request.contextPath}/resources/adminResources/admin/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="${pageContext.request.contextPath}/resources/adminResources/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="${pageContext.request.contextPath}/resources/adminResources/js/demo/chart-area-demo.js"></script>
    <script src="${pageContext.request.contextPath}/resources/adminResources/js/demo/chart-pie-demo.js"></script>
